...
const Contact = () => {
  ...
  return (
    <>
      <Header />
      <div className="relative mx-auto h-screen w-full bg-black text-white-700">
            ...
            >
              <div>
                ...
                <input
                  ...
                  name="name"
                  placeholder="Name"
                  className="form-input w-full block shadow-sm rounded border-gray-300 bg-gray-100 text-black placeholder-black-300 focus:border-purple-400 focus:ring-1 focus:ring-purple-400"
                />
              </div>
              <div>
              ...
              <div className="col-span-full">
                ...
                <textarea
                  ...
                  className="form-textarea resize-none w-full shadow-sm rounded border-gray-300 bg-gray-100 placeholder-black-300 focus:border-purple-400 focus:ring-purple-400 text-black"
                ></textarea>
              </div>
              <div>
                <button
                  type="submit"
                  className="py-2 px-6 rounded bg-purple-600 text-base text-white font-semibold uppercase hover:bg-purple-700"
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
            <div className="mx-auto max-w-xl flex flex-col space-y-5">
              ...
              <p className="text-sm text-white-500">
                ...
                unde, voluptatibus nemo molestiae iure, repudiandae quaerat
                ipsam, labore sed dolorem nisi odit at esse ullam suscipit
                quidem necessitatibus aut modi.
              </p>
              <a
                href="mailto:placmenthub@gmail.com"
                className="inline-flex items-center text-sm text-blue-400 font-semibold hover:text-blue-500"
              >
                <MailIcon className="mr-2 w-5 text-white-400" />
                Mail-placmenthub@gmail.com
              </a>
              <a
                href="telto:placmenthub@gmail.com"
                className="inline-flex items-center text-sm text-blue-400 font-semibold hover:text-blue-500"
              >
                <PhoneIcon className="mr-2 w-5 text-white-400" />
                Phone-9810963305
              </a>
              <p className="inline-flex items-center text-sm text-blue-400 font-semibold hover:text-blue-500">
               <LocationMarkerIcon className="mr-2 w-5 text-white-400" /> Rajouri Garden Delhi
              </p>
